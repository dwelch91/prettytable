...
class PrettyTable(object):
    ...
    def __getitem__(self, index):
        ...
        if isinstance(index, slice):
            ...
            raise ValueError("Index %s is invalid, must be an integer or slice" % str(index))
    ...
    def _validate_field_names(self, val):
        ...
        if self._field_names:
            try:
                ...
                raise ValueError("Field name list has incorrect number of values, (actual) %d!=%d (expected)" % (len(val), len(self._field_names)))
        if self._rows:
            try:
                assert len(val) == len(self._rows[0])
            except AssertionError:
                raise ValueError("Field name list has incorrect number of values, (actual) %d!=%d (expected)" % (len(val), len(self._rows[0])))
    ...
    def _validate_header_style(self, val):
        try:
            ...
            raise ValueError("Invalid header style, use cap, title, upper, lower or None!")
    ...
    def _validate_int_format(self, name, val):
        ...
        try:
            ...
            raise ValueError("Invalid value for %s!  Must be an integer format string." % name)
    ...
    def _validate_float_format(self, name, val):
        ...
        try:
            ...
            raise ValueError("Invalid value for %s!  Must be a float format string." % name)
    ...
    def _validate_hrules(self, name, val):
        try:
            ...
            raise ValueError("Invalid value for %s!  Must be ALL, FRAME, HEADER or NONE." % name)
    ...
    def _validate_attributes(self, name, val):
        try:
            ...
            raise ValueError("attributes must be a dictionary of name/value pairs!")
    ...
    def add_row(self, row):
        ...
        if self._field_names and len(row) != len(self._field_names):
            raise ValueError("Row has incorrect number of values, (actual) %d!=%d (expected)" % (len(row), len(self._field_names)))
        if not self._field_names:
    ...
    def del_row(self, row_index):
        ...
        if row_index > len(self._rows) - 1:
            raise IndexError("Cant delete row at index %d, table only has %d rows!" % (row_index, len(self._rows)))
    ...
    def add_column(self, fieldname, column, align="c", valign="t"):
        ...
        if len(self._rows) in (0, len(column)):
            ...
            raise ValueError("Column length %d does not match number of rows %d!" % (len(column), len(self._rows)))
    ...
    def get_html_string(self, **kwargs):
        ...
        options = self._get_options(kwargs)
        return self._get_formatted_html_string(options) if options["format"] else self._get_simple_html_string(options)
